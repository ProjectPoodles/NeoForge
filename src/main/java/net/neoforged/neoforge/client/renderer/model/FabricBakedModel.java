...
package net.neoforged.neoforge.client.renderer.model;
...
import net.neoforged.neoforge.client.indigo.renderer.render.AbstractBlockRenderContext;
...
public interface FabricBakedModel {
    ...
    default void emitBlockQuads(BlockAndTintGetter blockView, BlockState state, BlockPos pos, Supplier<RandomSource> randomSupplier, RenderContext context) {
        if (false) {
            // TODO: if Indigo is active renderer
